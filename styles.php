...
<div id="ai-sidebar">
	...
	<div class="ai-sidebar-section">
		...
		<p>Synapse will be available here to assist you while editing stylesheets.</p>
	</div>
	<div class="ai-sidebar-section">
		<h5><i class="icon-lightbulb"></i> Planned Features</h5>
		<p>Ask questions about your CSS, get suggestions, and auto-complete snippets.</p>
	</div>
	<div class="ai-sidebar-section">
		<h5><i class="icon-cog"></i> Style Tools</h5>
		<p>Context-aware tools for the stylesheet currently open in the editor will appear here.</p>
	</div>
</div>
