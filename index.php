...
<div id="wrap">
	<nav class="navbar navbar-dark bg-dark fixed-top"><div class="container-fluid">
	  ...
	  <span class="navbar-text text-white">Your IP <strong><?php echo $_SERVER['REMOTE_ADDR']; ?></strong> is Logged</span>
	</div></nav>
	<div class="container">
		<form id="frm-login" class="form-signin" method="post" action="scripts/login.php">
			...
			<input type="text" id="txtemail" name="userid" data-bs-toggle="tooltip"
				class="input-block-level tooltipme2" data-bs-placement="top"
				title="Email address"
