...
if (!$_SESSION['EZUSERID'])
    die('<div><h1>Permission denied.<br>You must be logged in to access this</h1></div>');
         
// Check if user has permissions for this.
if (!isset($_SESSION['MANAGEFILES'])) $_SESSION['MANAGEFILES'] = false;
if (!$_SESSION['MANAGEFILES']) 
    die('<div><h1>Permission denied.<br>You must have page edit privileges to access this</h1></div>');
